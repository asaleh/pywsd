...
from lesk import simple_lesk, original_lesk, cosine_lesk, adapted_lesk
from similarity import max_similarity

print
"======== TESTING all-words lesk ===========\n"
for sentence in brown.sents()[:10]:
    ...
    print
    disambiguate(sentence, cosine_lesk, prefersNone=True)
    print
print

print
"======== TESTING all-words path maxsim ===========\n"
print
"This is going to take some time, have some coffee...\n"
for sentence in brown.sents()[0:1]:
    # Retrieves a tokenized text from brown corpus.
    sentence = " ".join(sentence)
    # Annotate the full sentence.
    print
    disambiguate(sentence, max_similarity, similarity_option='path')
    print
    disambiguate(sentence, max_similarity, similarity_option='wup')
print

print
"======== TESTING all-words info content maxsim ==========="
print
"===This is going to take some time, have some coffee...===\n"
for sentence in brown.sents()[0:1]:
    # Retrieves a tokenized text from brown corpus.
    ...
    # Annotate the full sentence.
    print
    disambiguate(sentence, max_similarity, similarity_option='lch')
    print
    disambiguate(sentence, max_similarity, similarity_option='res')
    print
    disambiguate(sentence, max_similarity, similarity_option='jcn')
    print
    disambiguate(sentence, max_similarity, similarity_option='lin')
